...
export function SiteFooter() {
  return <footer className="site-footer">
    <div className="site-footer__grid">
      ...
      <section><span className="footer-label">サービス</span><Link href="/catalog">動画を探す</Link><Link href="/pricing">料金プラン</Link><Link href="/team/join">チームコードを入力</Link><Link href="/team/manage">チーム管理</Link><Link href="/account/subscription">契約管理</Link><Link href="/mypage">マイページ</Link><Link href="/for-doctors">制作医師の方へ</Link></section>

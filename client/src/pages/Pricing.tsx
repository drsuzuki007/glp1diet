...
import { Check, CircleAlert, CreditCard, ShieldCheck, Sparkles } from "lucide-react";
  ...
  const checkout = trpc.subscription.createCheckout.useMutation({
    onSuccess: result => {
      if (result.alreadySubscribed) {
        toast.success("すでにSTANDARDプランへ加入済みです。");
        return;
      }

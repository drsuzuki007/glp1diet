...
const pageContent: Record<string, { eyebrow: string; title: string; lead: string; sections: { heading: string; body: string }[]; icon: typeof FileCheck2 }> = {
  "/for-doctors": { eyebrow: "FOR MEDICAL PROFESSIONALS", title: "制作医師の方へ", lead: "一般の方が医療情報を理解するための、透明性を大切にした講座制作にご協力ください。", icon: Stethoscope, sections: [{ heading: "MediVista Academy の考え方", body: "診断、処方、効果保証と誤認されない表現を大切にしながら、受診時の対話に役立つ一般向け教育コンテンツを届けます。" }, { heading: "制作・監修について", body: "講座ごとに制作医師、医学レビュー日、参考文献、利益相反の情報を表示します。具体的な制作のご相談は運営窓口までお問い合わせください。" }] },
  "/terms": { eyebrow: "TERMS OF USE", title: "利用規約", lead: "MediVista Academy の利用に関する基本事項を定めています。", icon: FileCheck2, sections: [{ heading: "サービスの目的", body: "本サービスは、一般の方が医療情報を理解することを補助する教育サービスです。個別の診断、治療、処方、服薬変更を提供するものではありません。" }, { heading: "デモ購入について", body: "本デモサイト内の購入操作は実課金を伴わず、カード情報の入力や金銭の請求は発生しません。" }] },
  "/privacy": { eyebrow: "PRIVACY", title: "プライバシーポリシー", lead: "学習体験に必要な情報を、目的に沿って適切に取り扱います。", icon: ShieldCheck, sections: [{ heading: "取得する情報", body: "ログイン時のアカウント情報、マイリスト、デモ購入、視聴進捗を、サービス提供と利用状況の表示のために保存します。" }, { heading: "情報の利用", body: "保存した情報は、本人のマイページにおける講座利用状態の表示に限って利用します。" }] },
  "/commercial": { eyebrow: "COMMERCIAL TRANSACTIONS", title: "特定商取引法に基づく表記", lead: "デモサイトにおける販売表示についてご案内します。", icon: FileCheck2, sections: [{ heading: "販売事業者", body: "MediVista Academy（デモサービス）" }, { heading: "価格・支払方法", body: "各講座に税込価格を表示しています。本サイトの購入フローはデモであり、実際の支払い・請求は行いません。" }] },

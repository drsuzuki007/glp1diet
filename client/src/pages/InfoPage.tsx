...
const pageContent: Record<string, { eyebrow: string; title: string; lead: string; sections: { heading: string; body: string }[]; icon: typeof FileCheck2 }> = {
  ...
  "/commercial": { eyebrow: "COMMERCIAL TRANSACTIONS", title: "特定商取引法に基づく表記", lead: "月額サブスクリプションの販売表示についてご案内します。", icon: FileCheck2, sections: [{ heading: "サービス名称", body: "glp1.diet 全講座見放題" }, { heading: "月額料金・支払方法", body: "月額料金は税込980円です。Stripe Checkoutで登録した支払方法により、加入日を基準として毎月請求されます。解約はStripe請求ポータルからお手続きいただけます。" }] },
